...
// ─── Pixel Spinner (only for individual image loading) ────────────────────────

function PixelSpinner() {
  return (
    <div className="relative w-10 h-10" aria-label="Loading image">
      {[...Array(8)].map((_, i) => (
        ...
        {item.githubUrl && (
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5
                       ...
                       outline outline-2 outline-[#333] rounded-sm
      ...
      <div className="w-full max-w-6xl">
        ...
        {projects.length === 0 ? (
          <div className="flex items-center justify-center py-20">
            <p className="text-orange-500 font-bold tracking-widest text-sm blink">
              ▶ NO PROJECTS FOUND
            </p>
          </div>
        ) : (
